...
const CreateUserModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  const modalStyle = isOpen ? "modal-position max-h-[90vh] md:max-h-[500px] overflow-y-auto fixed top-1/2 left-1/2 bg-white shadow-lg rounded-lg z-50" : "hidden";
  ...
  return (
    <>
      ...
      <div className=" p-8 px-10 min-h-[480px] ">
